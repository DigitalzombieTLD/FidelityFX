...
namespace AMD_FIDELITY_FX
{
    ...
    {
		public AMD_FIDELITY_FX_FSR(IntPtr obj0) : base(obj0)
		{
		}

		//[HideFromIl2Cpp]
		public AMD_FIDELITY_FX_FSR() : base(ClassInjector.DerivedConstructorPointer<AMD_FIDELITY_FX_FSR>()) => ClassInjector.DerivedConstructorBody(this);

		//[Header("FSR Compute Shaders")] 
		public ComputeShader computeShaderEASU = FidelityFX_Main.EdgeAdaptiveScaleUpsampling;
        public ComputeShader computeShaderRCAS = FidelityFX_Main.RobustContrastAdaptiveSharpen;
